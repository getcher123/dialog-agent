...
if (apiBase) {
  ...
  if (url.protocol !== 'https:' || url.username || url.password || url.search || url.hash) throw new Error('BETANCOURT_API_BASE must be a public HTTPS backend URL without credentials');
}
await mkdir(destination, { recursive: true });
// Deliberate allowlist: never publish the KB, fixtures, reports or .env.
