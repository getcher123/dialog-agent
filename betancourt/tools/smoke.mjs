...
const selected = process.argv.includes('--all') ? cases : cases.filter(q => ['Q03', 'Q04', 'Q05', 'Q06', 'Q12'].includes(q.id));
...
for (let i = 0; i < selected.length; i++) {
  if (i) await sleep(13000); // Stay below the real 5/IP/minute production limit.
